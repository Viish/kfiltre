...
# Generated by qmake (2.01a) (Qt 4.6.2) on: mer. janv. 12 10:23:53 2011
# Project:  KFiltre.pro
# Template: app
...
SOURCES       = main.cpp \
		...
		kfusion.cpp \
		kresizedialog.cpp \
		kmatrixdialog.cpp moc_mainwindow.cpp \
		moc_kfusion.cpp \
...
$(TARGET): ui_mainwindow.h ui_kfusion.h ui_kresizedialog.h ui_kmatrixdialog.h $(OBJECTS)  
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/KFiltre1.0.0/ && $(COPY_FILE) --parents mainwindow.h kimage.h tab.h histogram.h kgraphicsview.h kfiltre.h kfusion.h kresizedialog.h kmatrixdialog.h .tmp/KFiltre1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp kimage.cpp tab.cpp histogram.cpp kgraphicsview.cpp kfiltre.cpp kfusion.cpp kresizedialog.cpp kmatrixdialog.cpp .tmp/KFiltre1.0.0/ && $(COPY_FILE) --parents mainwindow.ui kfusion.ui kresizedialog.ui kmatrixdialog.ui .tmp/KFiltre1.0.0/ && (cd `dirname .tmp/KFiltre1.0.0` && $(TAR) KFiltre1.0.0.tar KFiltre1.0.0 && $(COMPRESS) KFiltre1.0.0.tar) && $(MOVE) `dirname .tmp/KFiltre1.0.0`/KFiltre1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/KFiltre1.0.0
...
compiler_moc_header_make_all: moc_mainwindow.cpp moc_kfusion.cpp moc_kresizedialog.cpp moc_kmatrixdialog.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainwindow.cpp moc_kfusion.cpp moc_kresizedialog.cpp moc_kmatrixdialog.cpp
...
moc_kmatrixdialog.cpp: kmatrixdialog.h
...
compiler_uic_make_all: ui_mainwindow.h ui_kfusion.h ui_kresizedialog.h ui_kmatrixdialog.h
compiler_uic_clean:
	-$(DEL_FILE) ui_mainwindow.h ui_kfusion.h ui_kresizedialog.h ui_kmatrixdialog.h
